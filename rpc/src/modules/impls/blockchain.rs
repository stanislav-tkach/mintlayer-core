...
use modules::helpers::errors::{
    block_at_height_not_found, block_not_found, transaction_not_found, transaction_of_side_branch,
    transaction_output_not_found,
};

use modules::traits::BlockChain;
use modules::types::GetTxOutSetInfoResponse;
use modules::types::H256;
use modules::types::U256;
use modules::types::{GetBlockResponse, RawBlock, VerboseBlock};
use modules::types::{GetTxOutResponse, TransactionOutputScript};
use network::Network;
use ser::serialize;
use storage;
use verification;
...
pub mod tests {
    ...
    use modules::helpers::errors::block_not_found;
    use modules::traits::BlockChain;
    use modules::types::Bytes;
    use modules::types::ScriptType;
    use modules::types::H256;
    use modules::types::{GetTxOutResponse, TransactionOutputScript};
    use modules::types::{RawBlock, VerboseBlock};
    use network::Network;
