...
use modules::types::GetRawTransactionResponse;
use modules::types::RawTransaction;
use modules::types::Transaction;
use modules::types::TransactionInput;
use modules::types::TransactionOutputs;
