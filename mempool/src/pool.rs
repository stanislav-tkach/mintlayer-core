...
impl MempoolStore {
    ...
    fn add_tx(&mut self, entry: TxMempoolEntry) -> Result<(), Error> {
        ...
        // TODO where should this be done with respect to entry insertion?
        // Answer: First, entry is inserted. Then, all modifications happen
        //self.rearrage();
...
mod tests {
    ...
    */
    ...
    fn descendant_score() -> anyhow::Result<()> {
        ...
        log::debug!("txs_by_descendant_score {:?}", txs_by_descendant_score);
